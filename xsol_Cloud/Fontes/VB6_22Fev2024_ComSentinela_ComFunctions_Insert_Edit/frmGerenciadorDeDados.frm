...
Begin VB.Form frmGerenciadorDeDados 
   ...
   Caption         =   "Gerenciador de dados (cripto)"
   ClientHeight    =   2340
   ClientLeft      =   5580
   ClientTop       =   3180
   ClientWidth     =   6840
...
Private Sub btnExecutarSql_Click()
    ...
    Dim comandoCriptografado As String
    Dim comandoDescriptografado As String
    
    comandoDescriptografado = retornaComandoNatural(txtHotFix.Text)
    
    On Error GoTo erro
    
    Set rs = Return_Recordset(comandoDescriptografado)
    Set rs = Nothing

...
Private Sub gestaoDeAgenda(codTecnico As String)
    ...
    If rs.Fields("Codigo") = "" Then 'Se for vazio o técnico não tem agenda ainda, então crio até dezembro
        For contador = 1 To 12
            rs.AddNew
            rs.Fields("CODIGO") = codTecnico
            rs.Fields("MES") = aMes(contador)
            rs.Update
        Next contador
    End If
...
Private Sub Fill_Grid(rs As ADODB.Recordset, Optional code As String)
    ...
    With Grid_Schedule
        ...
        Do Until rs.EOF
            count = count + 1
            .AddItem (rs.Fields("codigo") & vbTab & Get_Field_Val(rs.Fields("Dt_Atend_Serv")) & vbTab & Get_Field_Val(rs.Fields("Hr_Atend_Serv")) & vbTab & Get_Field_Val(rs.Fields("Nome_Cli")) & vbTab & Get_Field_Val(rs.Fields("Endereco")) & " - " & Get_Field_Val(rs.Fields("Bairro")) & vbTab & Get_Field_Val(rs.Fields("Equipamento")) & vbTab & Get_Field_Val(rs.Fields("Tipo_Serv")) & vbTab & Get_Field_Val(rs.Fields("Nome")) & vbTab & Get_Field_Val(rs.Fields("Valor_Serv")))
    ...
    Lbl_Registros_Result.Caption = rs.RecordCount
...
Private Function Return_SqlString(queryType As Integer, Optional param1 As String, Optional param2 As String, Optional param3 As String) As String
    ...
    If queryType = 1 Then
        ...
        If param2 <> "__/__/____" Then
            ...
            End If
            whereClause = whereClause & " a.Dt_Atend_Serv >= #" & CDate(Format(param2, "mm\/dd\/yyyy")) & "#"
        End If
        If param3 <> "__/__/____" Then
            ...
            Else
                whereClause = whereClause & " AND"
            End If
            whereClause = whereClause & " a.Dt_Atend_Serv <= #" & CDate(Format(param3, "mm\/dd\/yyyy")) & "#"
        End If
...
Sub Combo_Initialize()
    ...
    Combo_Tecnico.Clear
    Do While Not rs.EOF
       Combo_Tecnico.AddItem rs.Fields("Val")
       rs.MoveNext
    Loop
    rs.Close
    Set rs = Nothing
...
Private Sub But_Search_Click()
    'If Combo_Tecnico.Text = "" And Mask_Dt_Inicial.Text = "__/__/____" And Mask_Dt_Final.Text = "__/__/____" Then
    '    MsgBox "Informe ao menos o técnico ou datas para consulta", vbOKOnly, "Xsol Aquecedores"
    '    Exit Sub
    'End If

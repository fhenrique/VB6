...
Private Sub btnSalvar_Click()
    ...
    cloud_select = "Update `tecnicos_agenda` Set Dias = '" & txtDias.Text & "' where codigo = " & Form_Schedule.Text_Tecnico_Cod.Text & " And MES = '" & Mid(txtMes.Text, 1, 3) & "'"
    cloud_conexao.Execute (cloud_select)

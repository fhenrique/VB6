...
Begin VB.Form frmFerramentas 
   ...
   Begin VB.Frame Frame4 
      Caption         =   "Histórico Geral de empréstimos"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Private Sub btnEmprestimo_Click()
    ...
    If RTrim(LTrim(txtDescricao.Text)) = "" Then
        MsgBox "Selecine uma ferramenta na Lista de ferramentas cadastradas!"
        Exit Sub
    End If
...
Private Sub btnExcluir_Click()
    ...
    If btnExcluir.Caption = "Excluir" Then
        ...
        If MsgBox("Confirma a exlusão da ferramenta " & txtDescricao.Text & " ?", vbYesNo, "Confirmação") = vbYes Then
            'faz a exclusao ...
                 Call Return_Recordset(Return_SqlString(2, lblCodFerramenta.Caption)).Delete
...
Private Sub Form_Activate()
    Call carregaGridHistoricoGeral(Return_Recordset(Return_SqlString(5)))
End Sub
...
Private Sub ConfigureGridHistorico()
    With gridHistorico
        ...
        .ColWidth(0) = 3100 'Ferramenta
        .ColWidth(1) = 0 'Codigo (invisível")
        .ColWidth(2) = 0 'codigo ferramenta (invisivel)
        .ColWidth(3) = 1200 'Dt. emprestimo
        .ColWidth(4) = 2200 'Beneficiário(a)
        .ColWidth(5) = 2200 'Finalidade
        .ColWidth(6) = 1300 'Dt. devolucao
        .ColWidth(7) = 1000 'Devolvido?
        ...
        .Rows = 2
        .FixedRows = 1
        .TextMatrix(0, 0) = "Ferramenta"
        .TextMatrix(0, 1) = "Código"
        .TextMatrix(0, 2) = "Cód. Ferramenta"
        .TextMatrix(0, 3) = "Dt. Empréstimo"
        .TextMatrix(0, 4) = "Beneficiário"
        .TextMatrix(0, 5) = "Finalidade"
        .TextMatrix(0, 6) = "Dt. Devolução"
        .TextMatrix(0, 7) = "Devolvido?"
...
Private Sub ConfigureGridFerramentas()
    With gridFerramentas
        ...
        .ColWidth(1) = 3200 'descricao
        .ColWidth(2) = 1150 'dt. aquisicao
        .ColWidth(3) = 1900  'Comprador
        .ColWidth(4) = 1900 'Vendedor
...
Private Function Return_SqlString(queryType As Integer, Optional param1 As String, Optional param2 As String, Optional param3 As String) As String
    ...
    ElseIf queryType = 5 Then 'HISTÓRICO GERAL DE EMPRÉSTIMOS
        Return_SqlString = "SELECT FER.DESCRICAO, EMP.EMPRESTIMO_DTRETIRADA, EMP.EMPRESTIMO_BENEFICIARIO, EMP.EMPRESTIMO_FINALIDADE, EMP.EMPRESTIMO_DTDEVOLUCAO, IIf([EMP.EMPRESTIMO_DEVOLVIDO] = '0', 'N',    IIf([EMP.EMPRESTIMO_DEVOLVIDO] = '1', 'S')) AS DEVOLVIDO FROM FERRAMENTAS_EMPRESTIMO EMP INNER JOIN FERRAMENTAS FER ON FER.Codigo = EMP.CODIGO_FERRAMENTA order by EMP.EMPRESTIMO_DTDEVOLUCAO asc"
    End If
End Function
...
Private Sub carregaGridHistoricoGeral(rs As ADODB.Recordset, Optional code As String)
    Dim selectedRow As Integer
    ...
    With gridHistorico
        ...
        Do Until rs.EOF
                ...
                .AddItem (rs.Fields("DESCRICAO") & vbTab & vbTab & vbTab & rs.Fields("EMPRESTIMO_DTRETIRADA") & vbTab & rs.Fields("EMPRESTIMO_BENEFICIARIO") & vbTab & rs.Fields("EMPRESTIMO_FINALIDADE") & vbTab & rs.Fields("EMPRESTIMO_DTDEVOLUCAO") & vbTab & rs.Fields("DEVOLVIDO"))
                .row = .Rows - 1
                For col = .FixedCols To .Cols - 1
                    .col = col
                    
                    If rs.Fields("DEVOLVIDO") = "S" Then

...
Private Function Return_SqlString(queryType As Integer, Optional param1 As String, Optional param2 As String, Optional param3 As String, Optional param4 As String) As String
    ...
    If queryType = 1 Then
        Return_SqlString = "SELECT top 50 codigo,nome_cli,cpf,fone_celular, Aquivo_Morto, Aquivo_Morto_Justificativa FROM Clientes AS c"
    ElseIf queryType = 2 Then
    
        Return_SqlString = "SELECT * FROM Clientes AS c WHERE codigo = " & param1
        
    ElseIf queryType = 3 Then
        Return_SqlString = "SELECT top 50 c.codigo,nome_cli,cpf,fone_celular,Aquivo_Morto, Aquivo_Morto_Justificativa FROM Clientes c LEFT JOIN Endereco e ON c.codigo = e.cod_cliente"
        If param1 <> "" Then

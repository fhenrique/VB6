...
Private Sub Cmd_Salva_Click()
    ...
    Set rsFunci = db.OpenRecordset("Select  p2.endereco, a.Nome_Cli, a.Fone_celular, a.Fone_res, a.Fone_Com, a.e_mail From Clientes a INNER JOIN ENDERECO  as  p2 on  p2.cod_cliente = a.Codigo where endereco like '*portu*'")
    
    'MsgBox rsFunci.RecordCount
    
    'ver aqui se o endereço já existe para algum cliente
    'Call enderecoExistente(Return_Recordset(Return_SqlString(6, Text_End.Text)))
...
Private Sub Record_Record(rs As ADODB.Recordset)
   ...
   'If Trim(txtTipoTelhado.Text) <> "" Then
...
Private Function Return_Recordset2(strSql As String) As ADODB.Recordset
    ...
    rs2.Open strSql, conn, adOpenForwardOnly, adLockReadOnly
    
    'MsgBox rs2.RecordCount
    
    Set Return_Recordset2 = rs2
End Function
...
Private Function Return_SqlString(queryType As Integer, Optional param1 As String, Optional param2 As String, Optional param3 As String) As String
    ...
    ElseIf queryType = 6 Then
        Return_SqlString = "Select  p2.endereco, a.Nome_Cli, a.Fone_celular, a.Fone_res, a.Fone_Com, a.e_mail From Clientes a INNER JOIN ENDERECO  as  p2 on  p2.cod_cliente = a.Codigo where endereco like '*" & param1 & "*'"
    End If
End Function

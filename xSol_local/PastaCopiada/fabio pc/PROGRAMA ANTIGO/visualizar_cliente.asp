...
cliente = Request.QueryString("Codigo")
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
   ...
   %> 
  <tr>
    <td class="forTexts"><a href="obs_cliente.asp?serv=<%Response.Write(rs.Fields("Codigo"))%>&codigo=<%Response.Write(cliente)%>"><%Response.Write(rs.Fields("Dt_Atend"))%></a>&nbsp;</td>

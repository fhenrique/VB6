...
Begin VB.Form Form_Xsol_02 
   ...
   Begin VB.CommandButton Cmd_Finaliza 
      ...
      Width           =   1455
   End
   Begin VB.CommandButton Cmd_Busca_1 
...
If (Tabela_Clientes.BOF = False) And Tabela_Clientes.EOF = False Then
    Tipo = "Nome_Cli"
    PrevBookMark = Tabela_Clientes.Bookmark
    Pesq = InputBox("Pesquisa por Código da Base' Pesquisa")
    If Len(Pesq) <= 3 Then Exit Sub
       Criterio = Tipo & " LIKE '*" & Pesq & "*'"
       Tabela_Clientes.Find Criterio
    If Tabela_Clientes.EOF Then
       MsgBox ("Registro não Localizado")
       Tabela_Clientes.Bookmark = PrevBookMark
    'Else
    '   While Not Tabela_Clientes.EOF()
    '      If InStr(1, UCase(Tabela_Clientes("Nome_Cli")), UCase(Pesq)) Then
    '        Mostra_Registro
    '      End If
...
If Trim(Text_NomeCli.Text) = "" Then
   MsgBox "É necessário digitar o Nome do Cliente / Razão Social! ", vbOKOnly, "XSol Arte em Aquecedores"
   Text_NomeCli.SetFocus
   Exit Sub
End If
    
If Trim(Text_End.Text) = "" Then
   MsgBox "É necessário digitar o Endereço! ", vbOKOnly, "XSol Arte em Aquecedores"
   Text_End.SetFocus
   Exit Sub
End If

If Trim(Text_Bairro.Text) = "" Then
   MsgBox "É necessário digitar o Bairro! ", vbOKOnly, "XSol Arte em Aquecedores"
   Text_Bairro.SetFocus
   Exit Sub
End If

If Trim(Text_Cidade.Text) = "" Then
   MsgBox "É necessário digitar Cidade! ", vbOKOnly, "XSol Arte em Aquecedores"
   Text_Cidade.SetFocus
   Exit Sub
End If

If Combo_Uf.Text = "" And Text_Zona.Text = "" Then
   MsgBox "É necessário selecionar a Unidade Federativa! ", vbOKOnly, "XSol Arte em Aquecedores"
   Combo_Uf.SetFocus
   Exit Sub
End If

If Combo_Zona.Text = "" And Text_Zona.Text = "" Then
   MsgBox "É necessário selecionar a ZONA! ", vbOKOnly, "XSol Arte em Aquecedores"
   Combo_Zona.SetFocus
   Exit Sub
End If

If Combo_Solicitante.Text = "" And Text_Solicitante.Text = "" Then
  MsgBox "É necessário selecionar o Solicitante! ", vbOKOnly, "XSol Arte em Aquecedores"
   Combo_Zona.SetFocus
   Exit Sub
End If
...
Private Sub GravaRegistros()
   ...
   Tabela_Clientes.Fields("Data_Emissao").Value = Date
   ...
   If Trim(Text_Cpf.Text) = "" Then
      Tabela_Clientes.Fields("CPF").Value = Null
   Else
      Tabela_Clientes.Fields("CPF").Value = Text_Cpf.Text
   End If
   
   If Trim(Text_Cnpj.Text) = "" Then
      Tabela_Clientes.Fields("CNPJ").Value = Null
   Else
      Tabela_Clientes.Fields("CNPJ").Value = Text_Cnpj.Text
   End If
...
Text_Registro.Text = Tabela_Clientes.RecordCount

Text_Dt_Emis.Text = IIf(IsNull(Tabela_Clientes.Fields("Data_Emissao")), "", Tabela_Clientes.Fields("Data_Emissao"))

Text_NomeCli.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Nome_Cli")), "", Tabela_Clientes.Fields("Nome_Cli")))

Text_Cpf.Text = IIf(IsNull(Tabela_Clientes.Fields("CPF")), "", Tabela_Clientes.Fields("CPF"))

Text_Cnpj.Text = IIf(IsNull(Tabela_Clientes.Fields("CNPJ")), "", Tabela_Clientes.Fields("CNPJ"))

Text_Atendente.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Atendente")), "", Tabela_Clientes.Fields("Atendente")))

Text_End.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("End")), "", Tabela_Clientes.Fields("End")))

Text_Bairro.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Bairro")), "", Tabela_Clientes.Fields("Bairro")))

Text_Cidade.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Cidade")), "", Tabela_Clientes.Fields("Cidade")))

Text_Uf.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Uf")), "", Tabela_Clientes.Fields("Uf")))

Text_Cep.Text = IIf(IsNull(Tabela_Clientes.Fields("Cep")), "", Tabela_Clientes.Fields("Cep"))

Text_Ref.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Ref")), "", Tabela_Clientes.Fields("Ref")))

Text_Zona.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Zona")), "", Tabela_Clientes.Fields("Zona")))
...
Text_Tipo_Equip.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Tipo_Eq_Mod")), "", Tabela_Clientes.Fields("Tipo_Eq_Mod")))

Text_Solicitante.Text = UCase(IIf(IsNull(Tabela_Clientes.Fields("Solicitante")), "", Tabela_Clientes.Fields("Solicitante")))
